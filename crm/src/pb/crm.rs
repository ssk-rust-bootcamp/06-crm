...
pub mod user_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn create_user(
            ...
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("crm.UserService", "CreateUser"));
            self.inner.unary(req, path, codec).await
        }
    }
}
            ...
            match req.uri().path() {
                "/crm.UserService/GetUser" => {
                    ...
                    impl<T: UserService> tonic::server::UnaryService<super::GetUserRequest> for GetUserSvc<T> {
                        ...
                        fn call(&mut self, request: tonic::Request<super::GetUserRequest>) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move { <T as UserService>::get_user(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                ...
                "/crm.UserService/CreateUser" => {
                    ...
                    impl<T: UserService> tonic::server::UnaryService<super::CreateUserRequest> for CreateUserSvc<T> {
                        ...
                        fn call(&mut self, request: tonic::Request<super::CreateUserRequest>) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move { <T as UserService>::create_user(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
